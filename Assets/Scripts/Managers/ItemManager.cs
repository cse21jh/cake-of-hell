...
public class ItemManager : Singleton<ItemManager>
{
    ...
    public void AddProcessedItem(int code, string name, ItemLevel level, Sprite spriteimage, string keyword, string flavorText, float price)
    {
    ...
    public void AddBases()
    {
        ...
        AddProcessedItem(1001, "저주받은 흙", ItemLevel.C, Resources.Load<Sprite>("Sprites/Item/After Process/cursed mud"), "촉촉한 빵", "흙이 부드럽다니... 좀 이상하긴 해.", 10f);
        AddProcessedItem(1002, "진화한 흙", ItemLevel.B, Resources.Load<Sprite>("Sprites/Item/After Process/neo mud"), "쫄깃한 빵", "쫀드기 아닙니다. 구워 먹지 말 것.", 20f);
        AddProcessedItem(1003, "광택이 나는 레더", ItemLevel.A, null, "질긴 가죽", "오만 번 씹어도 안 끊기는 쫄깃함.", 30f);
        AddProcessedItem(1004, "뼈 반죽", ItemLevel.SS, null, "뼈", "수상할 정도로 바삭한 뼈.", 50f);
        AddProcessedItem(1005, "버섯 빵", ItemLevel.B, null, "독버섯", "향기롭게 죽어가는 건가... 살려줘요.....", 20f);
        AddProcessedItem(1006, "붉은 심장", ItemLevel.S, Resources.Load<Sprite>("Sprites/Item/After Process/red heart"), "심장", "물컹거리는 게 거의 버섯인데;;", 45f);
        AddProcessedItem(1007, "불타는 심장", ItemLevel.SS, null, "뜨거운 심장", "사람 마음에 불 지르지 마세요.", 55f);
    }

    public void AddIcings()
    {
        AddProcessedItem(2001, "회오리", ItemLevel.B, Resources.Load<Sprite>("Sprites/Item/After Process/tornado cream"), "날아가는", "와! 회오리! 에어컨 18도보다 시원하다!", 25f);
        AddProcessedItem(2002, "무지개빛 가루", ItemLevel.SS, null, "빛나는", "여기서 팡! 저기서 팡! 입 안에서 톡톡 터지는 무지개 스파클링!", 50f);
        AddProcessedItem(2003, "피냄새 크림", ItemLevel.S, null, "한 맺힌", "이가 시린데... 늙었나.....", 40f);
        AddProcessedItem(2004, "목소리 크림", ItemLevel.B, null, "아름다운", "헉! 이 풍미는 거의 캐비어...?", 25f);
        AddProcessedItem(2005, "상냥한 목소리 크림", ItemLevel.S, null, "나긋나긋한", "이 따뜻함은 뭐지...? 어머니의 품...?", 45f);
        AddProcessedItem(2006, "독 크림", ItemLevel.A, Resources.Load<Sprite>("Sprites/Item/After Process/poison cream"), "죽음의", "먹었을 때 아파도 우리 가게 정상 영업합니다.", 35f);
        AddProcessedItem(2007, "맹독 크림", ItemLevel.SS, null, "지옥의", "어라. 뒷목이 서늘한 건 기분 탓입니다.", 50f);
        AddProcessedItem(2008, "독버섯 크림", ItemLevel.B, null, "화려한", "느끼하다구요? 여기 라면 국물은 안 파는데.....", 25f);
    }

    public void AddToppings()
    {
        AddProcessedItem(3001, "유리 파편", ItemLevel.A, null, "따가운", "개운하네? 오늘은 양치 안 하고 자야지.", 30f);
        AddProcessedItem(3002, "유리 조각", ItemLevel.S, null, "치명적인", "슬러시도 아니고 왜 차가운 거야?", 45f);
        AddProcessedItem(3003, "레드 콘", ItemLevel.A, Resources.Load<Sprite>("Sprites/Item/After Process/redcone_item"), "뾰족뾰족한", "앗 따가! 벌에 쏘인 건 아니에요.", 30f);
        AddProcessedItem(3004, "썩은 거미줄", ItemLevel.SS, null, "썩은", "으... 이 퀴퀴한 건 뭐야..... 사람은 못 먹겠지만.....", 50f);
        AddProcessedItem(3005, "비늘 가루", ItemLevel.C, null, "반짝거리는", "생선보다도 비리지만 우리 가게에서 가장 잘나가요.", 10f);
        AddProcessedItem(3006, "이빨 초콜릿", ItemLevel.A, Resources.Load<Sprite>("Sprites/Item/After Process/tooth_chocolate"), "날카로운", "너무 달달해서 이가 썩을 것 같아...?", 35f);
        AddProcessedItem(3007, "악한 영혼의 가루", ItemLevel.S, null, "사탄의", "달콤한 악마는 좀 귀하군요.", 45f);
        AddProcessedItem(3008, "악한 악마의 가루", ItemLevel.SS, null, "지하의", "FOX시군요... 사람을 홀리네...", 55f);
    }
