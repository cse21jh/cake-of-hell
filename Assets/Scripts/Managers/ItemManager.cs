   ...
   public void AddBases()
    {
        ...
        AddProcessedItem(10001, "저주받은 흙", ItemLevel.C, Resources.Load<Sprite>("Sprites/Item/After Process/cursed mud"), "촉촉한 빵", "흙이 부드럽다니... 좀 이상하긴 해.", 10);
        AddProcessedItem(10002, "진화한 흙", ItemLevel.B, Resources.Load<Sprite>("Sprites/Item/After Process/neo mud"), "쫄깃한 빵", "쫀드기 아닙니다. 구워 먹지 말 것.", 20);
        ...
        AddProcessedItem(10006, "붉은 심장", ItemLevel.S, Resources.Load<Sprite>("Sprites/Item/After Process/red heart"), "심장", "물컹거리는 게 거의 버섯인데;;", 45);
    ...
    public void AddToppings()
    {
        ...
        AddProcessedItem(20002, "유리 조각", ItemLevel.S, null, "치명적인", "슬러시도 아니고 왜 차가운 거야?", 45);
        AddProcessedItem(20003, "레드 콘", ItemLevel.A, Resources.Load<Sprite>("Sprites/Item/After Process/redcone_item"), "뾰족뾰족한", "앗 따가! 벌에 쏘인 건 아니에요.", 30);
        ...
        AddProcessedItem(20006, "이빨 초콜릿", ItemLevel.A, Resources.Load<Sprite>("Sprites/Item/After Process/tooth_chocolate"), "날카로운", "너무 달달해서 이가 썩을 것 같아...?", 35);
    ...
    {
        AddProcessedItem(40001, "회오리", ItemLevel.B, Resources.Load<Sprite>("Sprites/Item/After Process/tornado cream"), "날아가는", "와! 회오리! 에어컨 18도보다 시원하다!", 25);
        ...
        AddProcessedItem(40006, "독 크림", ItemLevel.A, Resources.Load<Sprite>("Sprites/Item/After Process/poison cream"), "죽음의", "먹었을 때 아파도 우리 가게 정상 영업합니다.", 35);
